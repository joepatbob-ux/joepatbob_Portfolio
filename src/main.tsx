...
function applyFadeTuneOverrides(): { holdMs: number; totalMs: number } {
  ...
  try {
    ...
    if (raw) {
      ...
      if (typeof t.copyEnterSpan === 'number')
        document.documentElement.dataset.copyEnterVh = String(t.copyEnterSpan / 100)
      if (typeof t.copyExitSpan === 'number')
        document.documentElement.dataset.copyExitVh = String(t.copyExitSpan / 100)

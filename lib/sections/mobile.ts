...
export const mobile: Section = {
  ...
  overviewBody: `Principal product design for Sensi mobile — modernizing the core app, shipping feature surfaces that earn trust, and greenfield tools for installers. Three stories below cover the platform, Spotlight, and WR Connect.`,
  lessonTitle: 'Lessons',
